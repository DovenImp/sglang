...
class ModelRunner(ModelRunnerKVCacheMixin):
    ...
    def _resolve_eager_decode_pdmux(
        ...
        runner own the pdmux entry later.
        """
        if self.server_args.enable_pdmux:
    ...
    def _forward_raw(
        ...
        with ctx_mgr:
            ...
            # (non-graph) forward needs. Unified here so it can later move into
            # the runner's load_batch. The graph path skips it: capture/replay
